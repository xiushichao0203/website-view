  ...
  <div class="app-container">
    ...
    <el-card class="box-card" shadow="never">
      <div class="filter-container">
        ...
        />
        <el-button
          v-permission="['GET /weibo/user/list']"
          class="filter-item"
          type="primary"
          icon="el-icon-search"
          @click="handleFilter"
    ...
    <el-card class="box-card" shadow="never">
      ...
      >
        <el-table-column align="center" label="用户ID" prop="weiboId" sortable />

        <el-table-column align="center" label="用户姓名" prop="weiboName" />

        <el-table-column align="center" label="用户昵称" prop="nickName" />

        <el-table-column align="center" label="用户头像" prop="avatarHd">
          <template slot-scope="scope">
            <img v-if="scope.row.avatarHd" :src="scope.row.avatarHd" width="40" />
          </template>
        </el-table-column>

        <el-table-column align="center" label="用户简介" prop="description"></el-table-column>
      </el-table>
